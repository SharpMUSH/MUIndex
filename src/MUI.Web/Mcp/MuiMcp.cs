...
/// different thing: seven specific, authenticated tools (<see cref="MuiMcpTools"/>) built on the exact
...
/// of the seven tools needs the Postgres-backed crawler graph <c>AddMuiCrawler</c> registers; there is
