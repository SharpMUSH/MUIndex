...
public static partial class Messages
{
    ...
    private static Dictionary<string, string> StaticPages() => new(StringComparer.Ordinal)
    {
        ...
        ["about.feed.intermud3.note"] = "A network many LP-family games are joined to. We take its list of addresses, and ask the games that answer how many people are connected.",
